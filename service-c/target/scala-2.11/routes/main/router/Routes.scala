...
class Routes(
  ...
  def documentation = List(
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """sendMail""", """controllers.Application.sendMail"""),
  ...
  // @LINE:8
  private[this] lazy val controllers_Application_sendMail1_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("sendMail")))
  )
  private[this] lazy val controllers_Application_sendMail1_invoker = createInvoker(
    Application_1.sendMail,
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "sendMail",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:8
    case controllers_Application_sendMail1_route(params) =>
      call { 
        controllers_Application_sendMail1_invoker.call(Application_1.sendMail)
      }
  
    // @LINE:10
    case controllers_Application_health2_route(params) =>
      call { 
        controllers_Application_health2_invoker.call(Application_1.health)
      }
